...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-daemon-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-daemon-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-daemon
# for installing globally
pixi global install python-daemon
```
...
It is possible to list all of the versions of `python-daemon` available on your platform:
...
```
pixi search python-daemon --channel conda-forge
```
